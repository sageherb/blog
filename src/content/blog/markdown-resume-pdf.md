...
UI가 컴포넌트 단위로 관리되기 때문에 이력서와 포트폴리오가 동일한 디자인으로 통일성 있게 구현된다.

파일을 수정할 때마다 Git 커밋을 해서 버전 관리도 가능하다.

## 마무리

사실 이 프로젝트는 학습의 목적이 아니라 내 불편함을 없애기 위해 시작한 프로젝트였다.

그래도 이렇게 새롭게 배우게 되는 것들이 있고, 작은 자동화라도 내가 반복해서 겪는 불편을 줄인 경험도 굉장히 가치가 있었다.
